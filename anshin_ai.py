...
[data-testid="stChatMessage"]:has([data-testid="chatAvatarIcon-user"]) {
    background: rgba(244,175,194,0.4) !important;
    border: 1px solid rgba(217,127,163,0.2) !important;
}

[data-testid="stChatMessage"]:has([data-testid="chatAvatarIcon-assistant"]) {
    background: rgba(255,250,252,0.85) !important;
    border: 1px solid rgba(244,175,194,0.2) !important;
}
...
def therapist_response(user_input, base_response, emotion):
    responses = {
        "sadness": "ごめんね、つらかったんだね。💗\n\nI'm really sorry you're feeling this way. It sounds like you're carrying something heavy. Can you tell me more about what's been on your mind?",
        "fear": "大丈夫だよ、ゆっくり深呼吸して。🌿\n\nIt sounds like you're feeling anxious. Let's slow things down together. What's worrying you the most right now?",
        "anger": "怒るのは当然だよ。🌸\n\nI hear that you're frustrated — that's completely valid. Do you want to talk about what triggered this feeling?",
        "joy": "それは嬉しいね！✨\n\nThat's really lovely to hear! What made you feel this way today?",
...
for key, default in [("chat_history_ids", None), ("messages", []), ("memory", [])]:
...
if user_input:
    ...
    with st.chat_message("assistant"):
        ...
        base_res = tokenizer.decode(st.session_state.chat_history_ids[:, bot_input_ids.shape[-1]:][0], skip_special_tokens=True)
        final_response = therapist_response(user_input, base_res, emotion)
